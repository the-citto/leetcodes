...
#
# project-struct: python/leetcode/__init__.py python/leetcode/__main__.py python/leetcode/py.typed tests/__init__.py
#
# python/leetcode:
# 	mkdir -p python/leetcode
#
# python/leetcode/__init__.py: python/leetcode
# 	touch python/leetcode/__init__.py
#
# python/leetcode/__main__.py: python/leetcode
# 	touch python/leetcode/__main__.py
#
# python/leetcode/py.typed: python/leetcode
# 	touch python/leetcode/py.typed
#
# tests/__init__.py:
# 	mkdir -p tests
